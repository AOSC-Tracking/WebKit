...
{
    if (!attributes.hasSpreadMethod() && (element.isAnimatedAttribute(SVGNames::spreadMethodAttr) || element.hasAttribute(SVGNames::spreadMethodAttr)))
        attributes.setSpreadMethod(element.spreadMethod());

    if (!attributes.hasGradientUnits() && (element.isAnimatedAttribute(SVGNames::gradientUnitsAttr) || element.hasAttribute(SVGNames::gradientUnitsAttr)))
        attributes.setGradientUnits(element.gradientUnits());

    if (!attributes.hasGradientTransform() && (element.isAnimatedAttribute(SVGNames::gradientTransformAttr) || element.hasAttribute(SVGNames::gradientTransformAttr)))
    ...
    if (isRadial) {
        ...
        if (!attributes.hasCx() && (element.isAnimatedAttribute(SVGNames::cxAttr) || element.hasAttribute(SVGNames::cxAttr)))
            attributes.setCx(radial.cx());

        if (!attributes.hasCy() && (element.isAnimatedAttribute(SVGNames::cyAttr) || element.hasAttribute(SVGNames::cyAttr)))
            attributes.setCy(radial.cy());

        if (!attributes.hasR() && (element.isAnimatedAttribute(SVGNames::rAttr) || element.hasAttribute(SVGNames::rAttr)))
            attributes.setR(radial.r());

        if (!attributes.hasFx() && (element.isAnimatedAttribute(SVGNames::fxAttr) || element.hasAttribute(SVGNames::fxAttr)))
            attributes.setFx(radial.fx());

        if (!attributes.hasFy() && (element.isAnimatedAttribute(SVGNames::fyAttr) || element.hasAttribute(SVGNames::fyAttr)))
            attributes.setFy(radial.fy());

        if (!attributes.hasFr() && (element.isAnimatedAttribute(SVGNames::frAttr) || element.hasAttribute(SVGNames::frAttr)))
